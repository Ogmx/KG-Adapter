...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained_path', default='/raid_sdb/LLMs/llama2-7b-openorca-mc-v1', type=str)
    parser.add_argument('--kg_adapter_model_path', default='/raid_sdb/home/tsy/models/kg-adapter-llama', type=str)
    parser.add_argument('--kg_adapter_online_load', action='store_true')
    parser.add_argument('--save_path', default='/raid_sdb/home/tsy/KGLLM_ckpt/', type=str)
    ...
    parser.add_argument('--test_data_path', default='/raid_sdb/home/tsy/KG_data/all_data_test.csv', type=str)
